...
ChakraBrige is a library you can reference in your UWP project to embed Microsoft Chakra JavaScript engine in order to seamlessly use services provided by JavaScript framework.

## Solution content

* **ChakraBrige** is the WinRT component used to host Chakra JavaScript engine inside your application
